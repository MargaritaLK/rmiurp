    ...
    <div>
      ...
      <div className=" pt-[120px] min-h-screen flex-col items-center justify-between p-20 bg-[#1f3940]">
        ...
        <div className='my-20 w-3/5' >
          ...
          <div className="flex text-[#AAAFAF]  tracking-wider text-transform:uppercase  ">Welcome to our web app! Please note that the content and functionality are currently being tested for proof of concept. </div>
        </div>
